defmodule EmailReports.Dnsimple do
  ...
  def client(account) do
    %Dnsimple.Client{access_token: account.dnsimple_access_token, user_agent: "addon-email-reports"}
  end

  # Service modules

  defp oauth_service do
    Application.get_env(:email_reports, :dnsimple_oauth_service, Dnsimple.Oauth)
  end

  defp identity_service do
    Application.get_env(:email_reports, :dnsimple_identity_service, Dnsimple.Identity)
  end

  defp domains_service do
    Application.get_env(:email_reports, :dnsimple_domains_service, Dnsimple.Domains)
  end

  defp certificates_service do
    Application.get_env(:email_reports, :dnsimple_domain_certificates_service, Dnsimple.Certificates)
  end

  defp services_service do
    Application.get_env(:email_reports, :dnsimple_domain_services_service, Dnsimple.Services)
  end

  defp webhooks_service do
    Application.get_env(:email_reports, :dnsimple_webhooks_service, Dnsimple.Webhooks)
  end

  defp zones_service do
    Application.get_env(:email_reports, :dnsimple_zones_service, Dnsimple.Zones)
  end
end
