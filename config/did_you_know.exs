...
config :email_reports, did_you_know: [
  ~s(that the DNS system is over 30 years old?),
  ~s(that there were just 6 original TLDs?),
  ~s(that there are more than 148,344,875 registered domains?),
  ~s(that you can also lookup a domain from a IP address?),
